...
class ReportGenerator:
    ...
    def generate_markdown(
        ...
        md.append("=" * 80)
        md.append("*Generated by SysPulse Laptop Buyer Audit Engine v1.0.0 — Zero Marketing Bias.*")
        md.append("=" * 80)
...
<div class="container">
  ...
  <!-- Footer -->
  <div class="footer">
    SysPulse Laptop Buyer Audit Engine v1.0.0 &bull; Developed by Ajinkya Furange &bull; Grounded in Physical Hardware Reality
  </div>
