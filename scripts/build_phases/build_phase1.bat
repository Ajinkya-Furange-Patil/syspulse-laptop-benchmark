...
echo =======================================================================
echo   PC BENCHMARK SUITE - PHASE 1 BASELINE CALIBRATION BUILD AND RUNNER
echo =======================================================================
...
echo.
echo [1/2] Compiling src\phases\phase1_baseline\main_baseline.cpp...
cl /nologo /O2 /std:c++20 /EHsc /W4 /D_CRT_SECURE_NO_WARNINGS src\phases\phase1_baseline\main_baseline.cpp /Fe:bin\baseline.exe /Fo:build\ Powrprof.lib wbemuuid.lib ole32.lib oleaut32.lib Advapi32.lib
...
echo.
echo =======================================================================
echo   [2/2] RUNNING PHASE 1 BASELINE CALIBRATION (5 IDLE SAMPLES)
echo =======================================================================
bin\baseline.exe 5
